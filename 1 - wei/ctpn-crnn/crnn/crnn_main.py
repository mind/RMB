...
def val(net, dataset, criterion, max_iter=200):
    print('Start val')
            ...
            if i % params.valInterval == 0:
                ...
                if acc>best:
                    ...
                    torch.save(crnn.state_dict(),
                               '{0}/best_model_{1}_{2}.pth'.format(params.experiment, total_steps, i)) 
...
if __name__ == '__main__':
    ...
    test_dataset = dataset.lmdbDataset(
        root=opt.valroot, transform=dataset.resizeNormalize((192, 32)))
    ...
    if opt.model_path != '':
        ...
        start = int(str(opt.model_path).split('_')[2]) + 1
